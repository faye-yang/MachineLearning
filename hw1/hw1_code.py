...
def loaddata(data_file1,data_file2):
...
training_cutoff = round(len(dataset_X) * 0.7)
validation_cutoff = round(len(dataset_X) * 0.85)
test_cutoff = len(dataset_X) - 1

training_X = dataset_X[0:training_cutoff]
training_target = dataset_target[0:training_cutoff]
...
def compute_information_gain(xi,data):
    ...
    train_cutoff = round(len(data)*0.70)
...
real_t=real_t1+real_t2
    fake_t=fake_t1+fake_t2
    x1=real_t1+fake_t1
    x2=real_t2+fake_t2
...
if __name__ == "__main__":
    dataset_X_feature_names, training_X, validation_X, test_X, training_target, validdation_target, test_target,data=loaddata("/Users/yufei/Desktop/2018fall/csc411/hw/hw1/clean_fake.txt","/Users/yufei/Desktop/2018fall/csc411/hw/hw1/clean_real.txt")
    select_model(dataset_X_feature_names, training_X, validation_X, training_target, validdation_target)
    compute_information_gain("trump",data)
