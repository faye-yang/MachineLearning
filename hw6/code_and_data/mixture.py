...
class Model(object):
    ...
    def update_pi(self, R):
        ...
        numerator = R.sum(axis=0) + c - 1
        denominator = R.sum() + K * c - K
    ...
    def update_theta(self, X, R):
        ...
        numerator = np.matmul(R.T, X) + a - 1
        denominator = R.sum(axis=0) + a + b - 2
        print(denominator)
...
if __name__ == '__main__':
    #print result from part1
    print_part_1_values()
    #print result from part2
    print_part_2_values()
